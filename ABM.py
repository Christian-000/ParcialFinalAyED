...
def ventana_eliminacion():
    ...
    label_registro = tk.Label(nueva_ventana, text="Opciones de Eliminación", font=('Arial', 18), bg="#041E2C", fg="#fff")
    label_registro.grid(row=1, column=0, pady=10, columnspan=5, padx=10)
...
def ventana_actualizar():
    ...
    label_registro = tk.Label(nueva_ventana, text="Opciones de Actualización", font=('Arial', 18), bg="#041E2C", fg="#fff")
    label_registro.grid(row=1, column=0, pady=10, columnspan=5, padx=10)
